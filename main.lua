...
local clientId
local isMobile = (not syn and not Krnl and not is_sirhurt_closure) 

if isMobile then
    clientId = getgenv().name -- ถ้าเป็นมือถือใช้ name แทน clientId
else
...
if response and response.Body then
    ...
    print("🔍 Debug JSON Response:", jsonResponse.status)
